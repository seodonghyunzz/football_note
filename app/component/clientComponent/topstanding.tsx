...
interface TopStandingProps {
  top: standingsTeam[];
}

export default function TopStanding({ top }: TopStandingProps) {
  return (
    <div
      className="w-full max-w-4xl bg-white rounded-lg shadow overflow-hidden font-[Dongle]"
